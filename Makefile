...
APPNAME=mtb-example-threadx-wifi-twt
...
# added to the build
#
# WCM is needed to compile Wi-Fi utility of command-console library
COMPONENTS=WCM
...
DEFINES+=CY_RETARGET_IO_CONVERT_LF_TO_CRLF HAVE_SNPRINTF CY_RTOS_AWARE 
